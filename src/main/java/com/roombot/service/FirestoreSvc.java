...
public class FirestoreSvc { // for talking to firestore
    ...
    public List<QueryDocumentSnapshot> findAll(String collection) // takes in a string to indicate the collection it is
                                                                  // finding
        ...
        return db.collection(collection) // finding collection
                .get().get() // after obtaining the collection, second .get unwraps it to get the value w
                             // wrapped inside
